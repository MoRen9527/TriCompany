...
- FullStackDeveloper 员工实例的具体社交连续性写入 support employee workspace 或 runtime cognition state。
...
- social 层用于承载当前 FullStackDeveloper 员工实例的轻社交连续性、非正式称呼、互动偏好和闲聊层面的待确认信息。
