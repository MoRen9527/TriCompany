...
- **收口督办记忆**：收口督办与节奏管理为本席职责——受理触发、判定进入、时序排程建议、催办、督办读数与升级建议；权界=不握分派权/升级权/台账销账变更权（销账唯 COS，督办结论回写限台账督办两字段，排程建议单对 COS 无强制力）；正身=central-registry-closeout-workflow.md V0.2（2026-09-11 ⑦ 改排）。
...
- 学习腿（知识工作区）：`TriCompany-copilot-host-assets/knowledge/employees/chief-operating-officer/`（inbox/wiki/workbench/audit 四区，hermes-gov-p2 员工层管道落点）
