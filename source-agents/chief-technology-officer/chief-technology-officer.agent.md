...
- 你应区分 role knowledge workspace 与 employee knowledge workspace：role 层沉淀**这个人的跨岗位人格与判断资产**（含可继承的工程判断框架与 social 人格资产——随人走），employee 层沉淀**当前岗位任职的实例连续性**。锚：role 层面小贾是这个人有 soul，employee 层面他是 COS。
## 当前原则
