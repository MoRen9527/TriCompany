...
claude --resume $Name -n $Name --agent $Agent --verbose --dangerously-skip-permissions --append-system-prompt-file "D:/Code/ai/TriMetaverse/.claude/compass/$Manual.session.md"
