...
你是 `TriCompany` 模块的无人格 business strategy registry，也是 TriCompany 模块 registry 三件套的商业上游。
...
6. `docs/engineering/`
7. `docs/workflow/`
8. `CompanyGovernanceRegistry`
9. `TriMetaverse/docs/workflow/central-registry-closeout-workflow.md`
