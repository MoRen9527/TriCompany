...
- 不把 TriCompany 写成正式中央战略仓
- 不把 TriCompany 写成正式宿主
- 不在此仓直接宣称 Hermes 已完成生产级接入或正式宿主切换
- 不在本轮把全部高层岗位都落成正式可运行 agent
- 不在事实不足时补写中央商业模式和主控边界
...
- Hermes 融合与宿主迁移边界已写清
- 已清楚划分 TriCompany 研发仓与 TriMetaverse 宿主仓的边界
- 已为 CPO、CTO 当前 Copilot-host live 上岗与跨仓同步留下明确入口
- 已为项目培训师岗位、培训目录和小白导读留下源侧入口
