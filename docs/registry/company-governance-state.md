...
- **Board 非人格席位件发布链落位（2026-09-17 知会登记）**：源侧三件（D2 批准线）+manifest 注册+两面渲染（`.claude/agents/board.md` 等全套）——Board 系可 spawn 非人格席位类型；roster 未登记（无 staffing 换代语义）；契约面归 CGR 治理域（本行即登记）。COS 定谳入册批（CHO 696d93a）与 Board 立章知会已在本 registry 与秘书处制度现势，索引归档随 GID 下一次触碰顺办。
