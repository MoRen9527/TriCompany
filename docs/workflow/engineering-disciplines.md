...
1. **定名条款**：正式名=**任务进度总表（Task Inventory）**；文件名随日版次 `task-inventory-YYYYMMDD.md`（首铸衔接=f6a045de task-inventory-20260924.md）；**挂位=条 5 总进度汇报标准格式正身即此表**（v4 条 5 七列表=表列规范，本条定名+载体）；
